	...
	loop{
		try{
			if ImageSearch(&FoundX, &FoundY, 1400, 60, 1485, 120, "*TransBlack *80 " A_ScriptDir "\images\marker_prota.png"){
				...
				Loop {
					try{
						if !ImageSearch(&FoundX, &FoundY, 435, 760, 465, 790, "*TransBlack *12 " A_ScriptDir "\images\repeat_prota.png") and ImageSearch(&FoundX, &FoundY, 530, 170, 570, 210, "*TransBlack *8 " A_ScriptDir "\images\coin_prota.png"){
							SendInput "{3 Down}"
							Sleep 5
							SendInput "{3 Up}"
							Sleep 295
